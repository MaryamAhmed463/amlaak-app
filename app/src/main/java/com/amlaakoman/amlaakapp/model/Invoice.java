...
public class Invoice {
    ...
    String confirmation;
    Double km_span, km_perLitre;


    public Double getKm_span() {
        return km_span;
    }

    public void setKm_span(Double km_span) {
        this.km_span = km_span;
    }

    public Double getKm_perLitre() {
        return km_perLitre;
    }

    public void setKm_perLitre(Double km_perLitre) {
        this.km_perLitre = km_perLitre;
    }

    public String getKmImgUrl() {
        return kmImgUrl;
    }

    public void setKmImgUrl(String kmImgUrl) {
        this.kmImgUrl = kmImgUrl;
    }
