...
public class AlmahaReportHeaderAdapter extends RecyclerView.Adapter<AlmahaReportHeaderAdapter.ViewHolder> {
    ...
    public AlmahaReportHeaderAdapter(ArrayList<String> arrayListvcode, ArrayList<Double> arrayAmount, ArrayList<Double> arrayVolume, ArrayList<Double> arraykmperliter, Context context1, AlmahaRHFragment fragContext) {
        context1 = context1;
