 ...
 * Use the {@link ManagerReportsDFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ManagerReportsDFragment extends Fragment {
    ...
    public ManagerReportsDFragment() {
     ...
     * @return A new instance of fragment ManagerReportsDFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ManagerReportsDFragment newInstance(String param1, String param2) {
        ManagerReportsDFragment fragment = new ManagerReportsDFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_manager_reports_d, container, false);

        TextView txtheader = view.findViewById(R.id.txt_header);
        ImageView imgLogout = view.findViewById(R.id.img_logout);
        txtheader.setText("Detail Report");
        ...
        Fragment omanOilRDFragment = new OmanOilRDFragment();
        FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
        transaction.replace(R.id.container_d, omanOilRDFragment);
        ...
        btn_shell.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment shellRDFragment = new ShellRDFragment();
                FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                transaction.replace(R.id.container_d, shellRDFragment);
                transaction.addToBackStack(null);
                transaction.commit();
            }
        });
        btn_almaha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment almahaRDFragment = new AlmahaRDFragment();
                FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                transaction.replace(R.id.container_d, almahaRDFragment);
                transaction.addToBackStack(null);
                transaction.commit();
            }
        });
