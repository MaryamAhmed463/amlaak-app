...
public class ShellReportDetailAdapter extends RecyclerView.Adapter<ShellReportDetailAdapter.ViewHolder> {
    ...
    public ShellReportDetailAdapter(ArrayList<Invoice> invoiceArrayList, FragmentActivity activity, ShellRDFragment fragContext) {
        context1 = context1;
    ...
    public interface InvoiceSelectionAdapter {
        void ShellReportDetailAdapter(Invoice selecteInvoice);
